...
/// 1bit grayscale
pub(crate) const pal_gray_1bit: [u8; 6] = [0x00, 0x00, 0x00, 0xff, 0xff, 0xff];

/// 2bit grayscale
pub(crate) const pal_gray_2bit: [u8; 12] =
    [0x00, 0x00, 0x00, 0x55, 0x55, 0x55, 0xaa, 0xaa, 0xaa, 0xff, 0xff, 0xff];

/// 4bit grayscale
pub(crate) const pal_gray_4bit: [u8; 48] = [
...
/// 8bit grayscale
pub(crate) const pal_gray_8bit: [u8; 768] = [
...
pub(crate) const pal_xterm256: [u8; 768] = [
...
/// vt340 monochrome
pub(crate) const pal_vt340_mono: [u8; 48] = [
...
/// vt340 color
pub(crate) const pal_vt340_color: [u8; 48] = [
    0x21, 0x21, 0x21, // 1   Gray-2
    0x42, 0x42, 0x42, // 2   Gray-4
    0x66, 0x66, 0x66, // 3   Gray-6
    0x0F, 0x0F, 0x0F, // 4   Gray-1
