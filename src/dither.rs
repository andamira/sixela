...
use crate::{
    ...
    DiffusionMethod, MethodForLargest, MethodForRep, PixelFormat, Quality, SixelError, SixelResult,
    SIXEL_PALETTE_MAX,
};
...
impl DitherConf {
    ...
    pub fn set_diffusion_method(&mut self, method: DiffusionMethod) {
        self.method_for_diffuse = if matches!(method, DiffusionMethod::Auto) {
            if self.ncolors > 16 {
                DiffusionMethod::FS
            } else {
